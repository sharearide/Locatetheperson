package com.example.bunty.locatetheperson.adapters;
...
import com.example.bunty.locatetheperson.Person;
import com.example.bunty.locatetheperson.R;
...
//    OnItemClickListener mItemClickListener;
   // private String data[];
    ...
    public ViewHolderBusInfo onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=layoutInflater.inflate(R.layout.each_user_info,parent,false);
...
//    public void setData1(ArrayList<> list1)
//    {
//        this.list1=list1;
...
//        });
    ...
    class ViewHolderBusInfo extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView name,time,distance;
        Button chat;
